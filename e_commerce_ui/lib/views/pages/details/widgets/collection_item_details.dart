...
import 'package:e_commerce_ui/views/pages/details/constants/texts.dart';
import 'package:e_commerce_ui/views/pages/details/widgets/add_to_card_widget.dart';
import 'package:e_commerce_ui/views/pages/details/widgets/item_details_dropdown.dart';
        ...
        Padding(
          ...
          child: RichText(
            text: const TextSpan(
              children: [
                TextSpan(
                    text: collectionItemDetailsText,
                    style: TextStyle(
                        fontSize: 18,
                        color: greyColor,
                        fontWeight: FontWeight.w600)),
